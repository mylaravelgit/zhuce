	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www5c1.53kf.com/webCompany.php?kf_sign=TMzMzMTU1NQxNjEwNjQ1ODI3MDMzMDA2NzIxMzI2ODY=&arg=10132686&style=2&kflist=off&kf=2851868912%40qq.com%2C2812393785%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F91laojie.com%2F&keyword=http%3A%2F%2F91laojie.com%2Fcompany%2Findex.html&brief=&logo=&question=&uid=ec177749156bfb1c149b59d4a8fb7ad0";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<DIV id=acc_title class=Lelem style=\"HEIGHT: 360px; WIDTH: 200px; POSITION: relative; Z-INDEX: 10000\" minHeight=\"100\" minWidth=\"100\" maxHeight=\"400\" maxWidth=\"400\"></DIV>";
			var is_autoyqk				= "1";
		...
		//	var acc_poptype			 = -1;
			...
			var pc_ivt_top = "40";
			var pc_ivt_left = "50";
			var callback_id6ds = "10184938,10184940,10184951,10213015,10263573,10283531,10320783,10325444";
			...
			if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			    		...
			    		Inv.prototype = {
			    			...
			    			talk : function(){
			    				...
			    				if (zdfq_type == 3) {
			    					...
			    					var openurl = "https://www5c1.53kf.com/webCompany.php?kf_sign=TMzMzMTU1NQxNjEwNjQ1ODI3MDMzMDA2NzIxMzI2ODY=&arg=10132686&style=2&kflist=off&kf=2851868912%40qq.com%2C2812393785%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F91laojie.com%2F&keyword=http%3A%2F%2F91laojie.com%2Fcompany%2Findex.html&brief=&logo=&question=&uid=ec177749156bfb1c149b59d4a8fb7ad0&tfrom=2" + force_kf;
			    					onliner_zdfq=2;
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="https://www5c1.53kf.com/img/upload/10132686/mobile/temp/mobile_53kf_1554859703.png"/>'+
	...
	//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑  2017版访客端新增 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
			...
			{
				if(zdfq_switch == 'yes') {
					//document.cookie = "onliner_zdfq72132686="+onliner_zdfq;
					document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
				} else {
					document.cookie = "my_acc_reauto_time=null;path=/";
				}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					...
					if(type==1){
						...
						if('1' == 0){
							...
							$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=4&interface_theme=1&minchat_style=1';
   ...
   //                  onliner_zdfq = 0;
			// 	}
   //              if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72132686="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF':
								var click_open_url = 'window.open(\"https://www5c1.53kf.com/webCompany.php?kf_sign=TMzMzMTU1NQxNjEwNjQ1ODI3MDMzMDA2NzIxMzI2ODY=&arg=10132686&style=2&kflist=off&kf=2851868912%40qq.com%2C2812393785%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F91laojie.com%2F&keyword=http%3A%2F%2F91laojie.com%2Fcompany%2Findex.html&brief=&logo=&question=&uid=ec177749156bfb1c149b59d4a8fb7ad0&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www5c1.53kf.com/webCompany.php?kf_sign=TMzMzMTU1NQxNjEwNjQ1ODI3MDMzMDA2NzIxMzI2ODY=&arg=10132686&style=2&kflist=off&kf=2851868912%40qq.com%2C2812393785%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F91laojie.com%2F&keyword=http%3A%2F%2F91laojie.com%2Fcompany%2Findex.html&brief=&logo=&question=&uid=ec177749156bfb1c149b59d4a8fb7ad0&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72132686&style_id=106177877\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
